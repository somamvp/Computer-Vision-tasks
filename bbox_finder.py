...
wanted={'7':'stroller','8':'stop'}
# wanted = {'19':'standing banner','4':'drainage','13':'unusual bench',
#             '8':'kickboard'}   #Chair set
